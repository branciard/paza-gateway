...
public class JHipsterProperties {
    ...
    public static class Mail {
        ...
        private String from = "pazagateway@localhost";
    ...
    public static class Swagger {
        ...
        private String title = "pazagateway API";

        private String description = "pazagateway API documentation";
    ...
    public static class Metrics {
        ...
        public static class Graphite {
            ...
            private String prefix = "pazagateway";
